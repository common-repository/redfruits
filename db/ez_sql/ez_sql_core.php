<?php
	...
	*/
	...
	if (!defined('EZSQL_VERSION')) define('EZSQL_VERSION','2.03');
	...
	if (!defined('EZSQL_CORE_ERROR')) define('EZSQL_CORE_ERROR','ezSQLcore can not be used by itself (it is designed for use by database specific modules).');
